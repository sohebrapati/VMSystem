        ...
        <section className="content">
          <div className="row">
            ...
            <div className="col-lg-3 col-xs-6">
              ...
              <div className="small-box bg-green">
                <div className="inner">
                  <h3>53<sup className="font-size-20">%</sup></h3>
                  <p>Bounce Rate</p>
                </div>
                <div className="icon">
          ...
          <div className="row">
            ...
            <section className="col-lg-7 connectedSortable">
              ...
              <div className="nav-tabs-custom" id="main">
                ...
                <div className="tab-content no-padding">
                  ...
                  <div className="chart tab-pane active" id="revenue-chart" className="revChart" ></div>
                  <div className="chart tab-pane" id="sales-chart" className="revChart"></div>
                </div>
              </div>
              ...
              <div className="box box-success">
                ...
                <div className="box-body chat" id="chat-box">
                  ...
                  <div className="item">
                    <img src="public/dist/img/user4-128x128.jpg" alt="user image" className="online" />
                    <p className="message">
                  ...
                  <div className="item">
                    <img src="public/dist/img/user3-128x128.jpg" alt="user image" className="offline" />
                    <p className="message">
                      <a href="#" className="name">
                  ...
                  <div className="item">
                    <img src="public/dist/img/user2-160x160.jpg" alt="user image" className="offline" />
                    <p className="message">
                      <a href="#" className="name">
              ...
              <div className="box box-info">
                ...
                <div className="box-body">
                  <form action="#" method="post">
                    ...
                    <div>
                      <textarea className="textarea" placeholder="Message" className="emailText"></textarea>
                    </div>
                  </form>
                </div>
            ...
            <section className="col-lg-5 connectedSortable">
              ...
              <div className="box box-solid bg-light-blue-gradient">
                <div className="box-header">
                  ...
                  <div className="pull-right box-tools">
                    ...
                    <button className="btn btn-primary btn-sm pull-right" data-widget="collapse" data-toggle="tooltip" title="Collapse" className="box-header-button"><i className="fa fa-minus"></i></button>
                  </div>
                ...
                <div className="box-body">
                  <div id="world-map" className="div-width div-height"></div>
                </div>
                <div className="box-footer no-border">
                  <div className="row">
                    <div className="col-xs-4 text-center" className="div-center">
              ...
              <div className="box box-solid bg-teal-gradient">
                ...
                <div className="box-body border-radius-none">
                  <div className="chart" id="line-chart" className="box-body-chart"></div>
                </div>
                <div className="box-footer no-border">
                  <div className="row">
                    <div className="col-xs-4 text-center" className="div-center">
              ...
              <div className="box box-solid bg-green-gradient">
                ...
                <div className="box-body no-padding">
                  ...
                  <div id="calendar" className="div-width"></div>
                </div>
                  ...
                  <div className="row">
                    <div className="col-sm-6">
                      ...
                      <div className="progress xs">
                        <div className="progress-bar progress-bar-green" className="width-90"></div>
                      </div>
                      ...
                      <div className="progress xs">
                        <div className="progress-bar progress-bar-green" className="width-70"></div>
                      </div>
                    </div>
                    <div className="col-sm-6">
                      <div className="clearfix">
                      ...
                      <div className="progress xs">
                        <div className="progress-bar progress-bar-green" className="width-60"></div>
                      </div>
                      ...
                      <div className="progress xs">
                        <div className="progress-bar progress-bar-green" className="width-40"></div>
                      </div>
                    </div>
                  </div>
                </div>
